            ...
            <section className="advent-section">
                <div className="advent-container">
                    <div className="img-trip">
                        <img src="https://kashmirtravelagent.com/images/Kashmir-Valley-649x396.jpg" />
